...
export const lightTheme = {
  ...
  colors: {
    ...
    colorControlNormalBorder: '#000',
    colorControlNormalFont: '#000',
    colorControlPrimaryBackground: '#F7F7FA',
    colorControlPrimaryBorder: 'blue',
    colorControlPrimaryFont: 'blue',
  },
}
...
export const darkTheme = {
  ...
  colors: {
    ...
    colorControlNormalBorder: '#fff',
    colorControlNormalFont: '#fff',
    colorControlPrimaryBackground: '#1B1D25',
    colorControlPrimaryBorder: 'bluesky',
    colorControlPrimaryFont: 'bluesky',
  },
}
